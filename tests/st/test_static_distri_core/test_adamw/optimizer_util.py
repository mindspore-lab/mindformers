...
def build_network(opt_config, net, is_group=None, loss_fn=None):
    ...
    net_opt = AdamW(params, weight_decay=0.1)  # 引用静态图新代码中的优化器类
...
# test result by megatron and apex
apex_loss = (
    np.array([0.38810229301452637, 5.8731255531311035, 8.452012062072754, 8.009958267211914, 4.623828887939453,
              1.6413345336914062, 4.204163551330566, 3.222878932952881, 1.183232307434082, 1.5830068588256836,
              1.860072135925293, 1.1271991729736328, 3.6157302856445312, 3.744617462158203, 0.5282754898071289,
              0.03458404541015625, 4.145437240600586, 3.204371452331543, 2.610919952392578, 2.7885818481445312],
             dtype=np.float32)
)

apex_fc1_weight_adamw_m = (
    np.array([[0.7527682781, 0.7527682781, 0.7527682781, 0.7527682781, 0.7527682781,
               0.7527682781, 0.7527682781, 0.7527682781],
              [0.2874042690, 0.2874042690, 0.2874042690, 0.2874042690, 0.2874042690,
               0.2874042690, 0.2874042690, 0.2874042690],
              [0.1256179810, 0.1256179810, 0.1256179810, 0.1256179810, 0.1256179810,
               0.1256179810, 0.1256179810, 0.1256179810],
              [-0.0690511391, -0.0690511391, -0.0690511391, -0.0690511391, -0.0690511391,
               -0.0690511391, -0.0690511391, -0.0690511391]], dtype=np.float32)

)

apex_fc2_weight_adamw_m = (
    np.array([[6.9784808159, 7.4703531265, 5.5084695816, 5.1763253212]], dtype=np.float32)
)
apex_fc1_weight_adamw_v = (
    np.array([[0.2891325951, 0.2891325951, 0.2891325951, 0.2891325951, 0.2891325951, 0.2891325951,
               0.2891325951, 0.2891325951],
              [0.0142021142, 0.0142021142, 0.0142021142, 0.0142021142, 0.0142021142, 0.0142021142,
               0.0142021142, 0.0142021142],
              [0.0019935537, 0.0019935537, 0.0019935537, 0.0019935537, 0.0019935537, 0.0019935537,
               0.0019935537, 0.0019935537],
              [0.0452103354, 0.0452103354, 0.0452103354, 0.0452103354, 0.0452103354, 0.0452103354,
               0.0452103354, 0.0452103354]], dtype=np.float32)
)

apex_fc2_weight_adamw_v = (
    np.array([[35.2178459167, 42.2833595276, 26.5230064392, 21.5100402832]], dtype=np.float32)
)
