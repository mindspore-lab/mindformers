...
\\test_pretrain_trainer.py
linux:
pytest ./tests/st/test_trainer/
test_contrastive_language_image_pretrain_trainer
/test_pretrain_trainer.py
"""
import os
import time
import numpy as np
...
from mindformers.trainer.contrastive_language_image_pretrain import\
    ContrastiveLanguageImagePretrainTrainer
from mindformers.mindformer_book import MindFormerBook
from mindformers.tools.register.config import MindFormerConfig


class TestContrastiveLanguageImagePretrainTrainer:
    """A test class for testing ContrastiveLanguageImagePretrainTrainer classes"""
    ...
    def test_trainer(self):
        """
        Feature: ContrastiveLanguageImagePretrainTrainer
        Description: training a model with ContrastiveLanguageImagePretrainTrainer
