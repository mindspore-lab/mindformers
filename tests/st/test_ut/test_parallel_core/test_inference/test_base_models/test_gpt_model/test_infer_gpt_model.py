...
# ============================================================================
"""mcore GPTModel UT of inference"""
...
SINGLE_CARD_TEST_CASES = [
    (
        # prefill, 并行策略: 单卡, Transformer Layer组成模块: Standard Norm, SelfAttention, MLP, num_layers: 2
    ...
    (
        # decode, 并行策略: 单卡, Transformer Layer组成模块: Standard Norm, SelfAttention, MLP, num_layers: 2
        # expected result: 功能跑通, 精度对齐。
        {"is_prefill": True, "num_experts": None, "moe_grouped_gemm": False, "qk_layernorm": False,
         "multi_latent_attention": False, "qk_l2_norm": False, "sandwich_norm": False, "num_layers": 2},
        {"output": "output_standard_layer1"},
