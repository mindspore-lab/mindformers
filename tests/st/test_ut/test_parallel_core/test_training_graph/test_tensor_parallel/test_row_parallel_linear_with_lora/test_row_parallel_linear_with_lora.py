...
# ============================================================================
"""Test RowParallelLinearWithLoRA with various configurations"""
...
def build_msrun_command_list(
    ...
    logger.info(f"Equivalent shell command for RowParallelLinearWithLoRA (approximate): {' '.join(cmd_list)}")
    return cmd_list


class TestRowParallelLinearWithLoRA:
    """Test class for RowParallelLinearWithLoRA with different configurations"""
    ...
    def setup_method(self):
        ...
        self.run_script_path = self.sh_path / "run_row_parallel_linear_with_lora.py"
...
class TestRowParallelLinearWithLoRASingleCard(TestRowParallelLinearWithLoRA):
    """Test class for RowParallelLinearWithLoRA with single card configurations"""
    @pytest.mark.level1
