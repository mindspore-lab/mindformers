...
# ============================================================================
"""Run RowParallelLinearWithLoRA accuracy test with configurable parameters via args"""
import argparse
import os
...
from mindformers.parallel_core.training_graph.tensor_parallel.lora_layers import RowParallelLinearWithLoRA
...
class RowParallelLinearWithLoRARunner:
    """Class to manage RowParallelLinearWithLoRA model and weights"""
    ...
    def build_model(self):
        """Build and initialize RowParallelLinearWithLoRA model"""
        net = RowParallelLinearWithLoRA(
...
def main():
    parser = argparse.ArgumentParser(description="Run RowParallelLinearWithLoRA test")
    ...
    # Prepare input
    runner = RowParallelLinearWithLoRARunner(args)
    runner.run()
