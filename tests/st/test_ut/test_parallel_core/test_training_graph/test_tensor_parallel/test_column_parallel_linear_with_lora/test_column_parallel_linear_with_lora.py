...
class TestColumnParallelLinearWithLoRA:
    ...
    def setup_method(self):
        ...
        self.run_script_path = self.sh_path / "run_column_parallel_linear_with_lora.py"
...
class TestColumnParallelLinearWithLoRASingleCard(TestColumnParallelLinearWithLoRA):
