...
# ============================================================================
"""Test VocabEmbedding with various configurations"""
...
def build_msrun_command_list(
    ...
    logger.info(f"Equivalent shell command for VocabEmbedding (approximate): {' '.join(cmd_list)}")
    return cmd_list


class TestVocabEmbedding:
    """Test class for VocabEmbedding with different configurations"""
    ...
    def setup_method(self):
        ...
        self.run_script_path = self.sh_path / "run_vocab_embedding.py"
