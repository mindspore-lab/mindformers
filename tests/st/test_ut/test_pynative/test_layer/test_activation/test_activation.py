...
from mindformers.pynative.layers.activation import GELU, SiLU, FusedSwiGlu
...
class TestActivation:
    ...
    def test_gelu_unapproximate(self):
        """
        Feature: Activation
        Description: Test Case: activation_func='gelu', approximate="tanh"
        Exception: AssertionError
        """
        self.run_test(activation=GELU(approximate="tanh"))
    ...
    @pytest.mark.platform_arm_ascend910b_training
    @pytest.mark.env_onecard
    def test_fusedswiglu(self):
        """
        Feature: Activation
        Description: Test Case: activation_func='fusedswiglu',
        Exception: AssertionError
        """
        self.run_test(activation=FusedSwiGlu())
