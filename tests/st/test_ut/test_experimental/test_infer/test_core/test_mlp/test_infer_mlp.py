...
class TestInferMLP:
    ...
    @staticmethod
    def check_function(output_ms_dict, data_keys):
        """
        ...
        for key, _ in data_keys.items():
            ...
            input_data = get_init_params(INPUT_SIZE, FFN_HIDDEN_SIZE)["input"]
    ...
    def run_test(
        ...
        if expect_error:
            ...
            # check whether the function of mlp module works properly.
            self.check_function(output_ms_dict, data_keys)
