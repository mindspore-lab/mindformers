...
# ============================================================================
"""
Test module for testing the paralleled MLP used for mindformers.
How to run this:
    pytest tests/st/test_example/test_graph/test_activation/test_activation.py
"""
import pytest
from mindformers.experimental.graph.activation import GELU, SiLU, SwiGlu
