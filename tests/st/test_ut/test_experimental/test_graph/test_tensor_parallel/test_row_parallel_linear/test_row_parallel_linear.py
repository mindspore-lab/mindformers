...
class TestRowParallelLinear:
    ...
    def test_single_card_configurations(self, model_args, data_keys, tmp_path):
    ...
    def test_four_cards_configurations(self, model_args, data_keys, tensor_parallel, tmp_path):
