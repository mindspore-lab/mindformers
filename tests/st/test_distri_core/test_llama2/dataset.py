...
def get_individual_dataset(
    ...
    if os.path.exists(data_dir):
        ...
        logger.warning(f"{data_dir} is not exist, use fake data for test case")
        fake_dataset = FakeData(data_num=16, seq_length=4096)
        dataset = ds.GeneratorDataset(fake_dataset,
