...
# ============================================================================
"""Test DeepseekV3 training with moe token permute"""
import os
...
class TestDeepseekV3:
    ...
    def setup_method(self):
        ...
        self.sh_path = Path(__file__).parent.parent.resolve()
    ...
    def test_eight_card_configurations(self):
        ...
        cmd_list = [
            (f"msrun --worker_num=8 --local_worker_num=8 --master_port={port_id} --log_dir=./msrun_log_deepseekv3 "
             f"--join=True {self.run_script_path} --mode=moe_token_permute",
