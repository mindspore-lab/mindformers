...
from mindformers.models import ChatGLM4Tokenizer, WhisperTokenizer, ChatGLMTokenizer
...
def create_glm_tokenizer():
    vocab_file = "/home/workspace/mindspore_vocab/GLM/ice_text.model"
