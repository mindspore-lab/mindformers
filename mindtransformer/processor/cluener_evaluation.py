...
from mindtransformer.processor.sample_process import label_generation, process_one_example_p
from mindtransformer.processor.crf import postprocess
from mindtransformer.processor.score import get_result
