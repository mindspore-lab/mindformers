...
# ============================================================================
"""Bert Trainer"""
from mindtransformer.models.nezha import NezhaConfig, NezhaNetworkWithLoss
...
class NezhaTrainingConfig(TrainingConfig):
    """
    BertTrainingConfig
    """
...
class NezhaTrainer(Trainer):
    """
    NezhaTrainer
    """

    def build_model_config(self):
        model_config = NezhaConfig()
        return model_config

    def build_model(self, model_config):
        net_with_loss = NezhaNetworkWithLoss(model_config)
...
if __name__ == "__main__":
    config = NezhaTrainingConfig()
    parse_config(config)
    trainer = NezhaTrainer(config)
    trainer.train()
