...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--eot", type=int, default=3, help="Eod of text depends on the vocab file."
    )
    ...
    word_tokenizer = AutoTokenizer.from_pretrained("gpt2")

    transforms_count = 0
    if args.dataset_type == "wiki":
        wiki_writer = FileWriter(
        ...
        file_names = [
            "{}{}".format(args.output_file, str(x).rjust(SUFFIX, "0"))
