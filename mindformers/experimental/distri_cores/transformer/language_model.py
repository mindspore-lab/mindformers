...
from mindformers.experimental.distri_cores.transformer import Module, ParallelTransformer, RotaryEmbedding
from mindformers.experimental.distri_cores.transformer.mlp import ParallelMLP
from mindformers.experimental.distri_cores.tensor_parallel import GatherFromSequenceParallelRegion, \
...
class Pooler(Cell):
    ...
    def __init__(self, hidden_size, init_method, config, **kwargs):
        ...
        self.gather_from_sequence_parallel_region = GatherFromSequenceParallelRegion(tensor_parallel_output_grad=False)
