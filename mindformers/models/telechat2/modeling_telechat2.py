...
class TeleChat2ForCausalLM(Telechat2PreTrainedModel):
    r"""
    Provide Telechat2 Model for training and inference.
    Args:
        config (Telechat2Config): The config of Qwen3 model.
    ...
    def __new__(cls, config):
        ...
        raise NotImplementedError("Telechat2 is not yet supported for training.")
