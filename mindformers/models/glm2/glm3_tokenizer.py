...
class ChatGLM3Tokenizer(PreTrainedTokenizer):
    ...
    Args:
        ...
        pad_token (Union[str, tokenizers.AddedToken], optional): A special token used to make arrays of tokens the
            same size for batching purpose. Will then be ignored by attention mechanisms or loss computation.
            Default: `"<pad>"` .
        unk_token (Union[str, tokenizers.AddedToken], optional): The unknown token. Default: `"<unk>"` .
