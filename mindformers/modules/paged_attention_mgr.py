...
class PagedAttentionMgr(nn.Cell):
    ...
    def __init__(self,
        ...
        self.paged_attention = P.auto_generate.PagedAttention(self.n_heads // mp, self.scale_value,
                                                              self.n_kv_heads // mp)
        self.paged_attention_with_alibi = P.auto_generate.PagedAttentionMask(self.n_heads // mp,
                                                                             self.scale_value,
                                                                             self.n_kv_heads // mp)
