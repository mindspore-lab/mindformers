...
|:-------------------------------------:|:------------------------------------------------------------------------------------------------------------------------------------------:|:---------------------------------------------------------------------:|
| [BERT](api_cards/model_cards/bert.md) |                                                          masked_language_modeling                                                          | [bert_base_uncased](configs/bert/model_config/bert_base_uncased.yaml) |
...
|                SimMIM                 |                                                           masked_image_modeling                                                            |                         simmim_swin_base_p4w7                         |
