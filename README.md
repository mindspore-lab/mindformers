...
|:-------------------------------------:|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------:|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------:|
| [BERT](docs/model_cards/bert.md) |                                                                   masked_language_modeling <br/> text_classification                                                                    |      [bert_base_uncased](configs/bert/model_config/bert_base_uncased.yaml) <br/> [txtcls_bert_base_uncased](configs/txtcls/model_config/txtcls_bert_base_uncased.yaml) <br/> [txtcls_bert_base_uncased_mnli](configs/txtcls/model_config/txtcls_bert_base_uncased_mnli.yaml)      |
