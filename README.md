...
- High availability in training, ensuring stable operation of large models on clusters with tens of thousands of GPUs.
...
|:----------------------------------------------------------------------------------------------------------------------------------------------|:------------------------------|:-----------------:|:------------------:|:--------------:|
| [Qwen3](https://gitee.com/mindspore/mindformers/blob/r1.7.0/configs/qwen3) ![Recent Popular](./docs/assets/hot.svg)                           | 0.6B/1.7B/4B/8B/14B/32B       |     Dense LLM     |       Mcore        |     1.8.0      |
| [Qwen3-MoE](https://gitee.com/mindspore/mindformers/blob/r1.7.0/configs/qwen3_moe) ![Recent Popular](./docs/assets/hot.svg)                   | 30B-A3B/235B-A22B             |    Sparse LLM     |       Mcore        |     1.8.0      |
| [DeepSeek-V3](https://gitee.com/mindspore/mindformers/blob/r1.7.0/research/deepseek3) ![Recent Popular](./docs/assets/hot.svg)                | 671B                          |    Sparse LLM     |    Mcore/Legacy    |     1.8.0      |
| [GLM4.5](https://gitee.com/mindspore/mindformers/blob/r1.7.0/configs/glm4_moe) ![Recent Popular](./docs/assets/hot.svg)                       | 106B-A12B/355B-A32B           |    Sparse LLM     |       Mcore        |     1.8.0      |
| [GLM4](https://gitee.com/mindspore/mindformers/blob/r1.7.0/configs/glm4) ![Recent Popular](./docs/assets/hot.svg)                             | 9B                            |     Dense LLM     |    Mcore/Legacy    |     1.8.0      |
| [Qwen2.5](https://gitee.com/mindspore/mindformers/blob/r1.7.0/research/qwen2_5) ![Recent Popular](./docs/assets/hot.svg)                      | 0.5B/1.5B/7B/14B/32B/72B      |     Dense LLM     |       Legacy       |     1.8.0      |
| [TeleChat2](https://gitee.com/mindspore/mindformers/blob/r1.7.0/research/telechat2) ![Recent Popular](./docs/assets/hot.svg)                  | 7B/35B/115B                   |     Dense LLM     |    Mcore/Legacy    |     1.8.0      |
