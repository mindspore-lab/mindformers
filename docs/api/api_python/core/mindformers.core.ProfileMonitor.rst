...
.. py:class:: mindformers.core.ProfileMonitor(start_step=1, stop_step=10, output_path=None, start_profile=True, profile_rank_ids=None, profile_pipeline = False, profile_communication=False, profile_memory=True, profiler_level=None, with_stack=False, data_simplification=True, config=None, **kwargs)
