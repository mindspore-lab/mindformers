...
.. py:class:: mindformers.experimental.parallel_core.pynative.transformer.ParallelTransformerLayer(config, layer_number, layer_type=1, self_attn_mask_type=1, drop_path_rate=0.0)
