...
| txtcls | txtcls_bert_case_uncased_mnli |   Mnli   | 84.8% | finetune<br/>eval<br/>predict | [link](../../scripts/examples/text_classification/txtcls_bert_base_uncased_finetune_on_mnli.sh) <br/> [link](../../scripts/examples/text_classification/txtcls_bert_base_uncased_mnli_eval_on_mnli.sh) <br/> [link](../../scripts/examples/text_classification/txtcls_bert_base_uncased_mnli_predict_on_mnli.sh) |
