...
How to run this:
pytest tests/st/test_multi_model/test_image_processor.py
"""
import numpy as np
import pytest
...
class TestImageProcessor:
    ...
    def test_processor(self):
        ...
        except_pixel_values = np.zeros((1, 1, 2, 3, 3, 3)).astype(np.float32)
        except_pixel_values[0][0][0] = [[[0.7332653, 0.8792495, 1.0252337],
        ...
        np.testing.assert_array_almost_equal(pixel_values, except_pixel_values)
