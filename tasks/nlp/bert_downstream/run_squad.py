...
from tasks.nlp.bert_downstream.src.bert_for_finetune import BertSquadCell, BertSquad
from tasks.nlp.bert_downstream.src.dataset import create_squad_dataset
...
def run_squad(args_opt):
    ...
    netwithloss = BertSquad(model_config, True, 2, dropout_prob=0.1)
    ...
    if args_opt.do_eval.lower() == "true":
        ...
        from tasks.nlp.bert_downstream.src.create_squad_data import read_squad_examples, convert_examples_to_features
        from tasks.nlp.bert_downstream.src.squad_get_predictions import write_predictions
        from tasks.nlp.bert_downstream.src.squad_postprocess import squad_postprocess
