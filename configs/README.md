...
- enable_mindio_ttp_save_ckpt：是否开启临终遗言功能，开启时需要配置相应的callback函数
...
- callbacks: 回调函数配置
    ...
    - type: TFTRegister:开启临终ckpt功能需要设置，可以参考[mindspore.train.TFTRegister](https://www.mindspore.cn/docs/zh-CN/master/api_python/train/mindspore.train.TFTRegister.html)
