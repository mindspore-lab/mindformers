...
from fm.src.utils.obs_tool import is_startswith_obs_prefix, OBS_PREFIX
from fm.src.adapter.utils.common import get_unique_name, select_with_priority
from fm.src.adapter.constants.ma import DEFAULT_DEVICE_NUM, DEFAULT_NODE_NUM, MA_JOB_DIR, \
