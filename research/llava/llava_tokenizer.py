...
class LlavaTokenizer(LlamaTokenizer):
    r"""
        Construct a Llava tokenizer. Based on byte-level Byte-Pair-Encoding. The default padding token is unset as there
        is no padding token in the original model.
