...
class TelechatTokenizerFast(PreTrainedTokenizerFast):
    """
    Construct a Telechat tokenizer. Based on byte-level Byte-Pair-Encoding.
    ...
    Args:
        ...
        use_default_system_prompt (bool, optional):
            Whether the default system prompt for Telechat should be used. Default: ``False`` .

    Returns:
        TelechatTokenizer, a TelechatTokenizer instance.

    Examples:
        >>> from transformers import TelechatTokenizerFast
        >>>
        >>> tokenizer = TelechatTokenizerFast(vocab_file="./telechat/tokenizer.model")
