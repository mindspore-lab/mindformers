...
class ChatGLM32kTokenizer(PreTrainedTokenizer):
    ...
    Examples:
        >>> from research.glm32k.glm32k_tokenizer import ChatGLM32kTokenizer
        >>> tokenizer = ChatGLM32kTokenizer('tokenizer.model')
        >>> prompts = ["晚上睡不着应该怎么办"]
    ...
    def build_single_message(self, role, metadata, message):
        """construct prompt for a single message"""
