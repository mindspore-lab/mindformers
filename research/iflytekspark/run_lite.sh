...
##### path join
model_dir=$model_root/${layers}-layer-bs${batch_size}-seq${max_seq_len}
...
full_cfg_path=./lite_config/full_dyn_infer_cfg.ini
inc_cfg_path=./lite_config/inc_dyn_infer_cfg_akg.ini
sample_config_path=./lite_config/inc_dyn_infer_cfg.ini
postprocess_config_path=./run_iflytekspark_13b_lite_infer_800T_A2_64G.yaml

##### call main.py
nohup python3 ./lite_infer_main.py --device_id $device_id \
