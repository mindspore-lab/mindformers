...
class Sampler(nn.Cell):
    r"""
    the postprocess sampler currently support using infer to do temperature, top_k and repetition_penalty.
    ...
    def construct(self, logits, temperature, repetition_penalty=1.0, input_ids=None):
        """sampler forward"""
        ...
        p_tmp, p_args = self.topk(logits, self.top_k)
