...
def main(config_path, use_parallel, load_checkpoint, vocab_file):
    ...
    model_config = YiZhaoConfig(**config.model.model_config)
    model_config.checkpoint_name_or_path = None

    # init tokenizer
    tokenizer = YiZhaoTokenizer(vocab_file=vocab_file)

    # build model
    network = YiZhaoForCausalLM(model_config)
    model = Model(network)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--config_path', default='predict_yizhao_12b_chat.yaml', type=str,
