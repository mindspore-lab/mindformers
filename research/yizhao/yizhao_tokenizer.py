...
class YiZhaoTokenizer(PreTrainedTokenizer):
    """
    Construct a YiZhao tokenizer. Based on byte-level Byte-Pair-Encoding.
    ...
    def _tokenize(self, text, **_kwargs):
        tokens = []
