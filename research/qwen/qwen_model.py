...
class QwenDecodeLayer(LLamaDecodeLayer):
    ...
    def __init__(self,
                 ...
                 **kwargs):
        super().__init__(batch_size=batch_size, seq_length=seq_length, layer_id=layer_id,
                         compute_dtype=compute_dtype, param_init_type=param_init_type, is_dynamic=is_dynamic,
