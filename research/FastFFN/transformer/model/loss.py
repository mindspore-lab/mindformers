...
from research.FastFFN.transformer.op_parallel_config import default_dpmp_config, OpParallelConfig
...
class _Softmax(Cell):
    ...
    def bprop(self, logits, label, dout):
...
class _NLLLoss(Cell):
    ...
    def bprop(self, softmax_result, one_hot_label, dout):
