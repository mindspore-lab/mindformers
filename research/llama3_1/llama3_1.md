...
Llama 3.1，是开源Llama系列的最新产品，目前有三个版本：Llama3.1-8B，Llama 3.1-70B，Llama 3.1-405B。
...
目前Mindformers支持Llama 3.1-8B，敬请期待Llama 3.1-70B与Llama 3.1-405B。
...
|:-------------------------------------------|:---------------------:|:---------:|:---------:|:------:|:--------:|:---------:|:------------:|
| [llama3_1_8b](./finetune_llama3_1_8b.yaml) |    text_generation    |  alpaca   |   8192    |   -    | Finetune |     -     | 3014 tks/s/p |
...
MindFormers提供`Llama3_1-8b`的快速推理脚本，脚本主要通过generate高阶接口实现，支持单卡推理。
