...
for i, (mask, score) in enumerate(zip(masks, scores)):
    ...
    plt.axis('off')
    plt.savefig(f"research/sam/examples/1-单点确定一个物体_{i}.png")
print(f"1-单点确定一个物体")
...
show_points(input_point, input_label, plt.gca())
plt.axis('off')
plt.savefig("research/sam/examples/2-两点确定相同物体.png")
print(f"2-两点确定相同物体")
...
plt.axis('off')
plt.savefig("research/sam/examples/3-两点确定不同物体.png")
print(f"3-两点确定不同物体")
...
show_points(input_point, input_label, plt.gca())
plt.axis('off')
plt.savefig("research/sam/examples/4-一个前景点和背景点.png")
print(f"4-一个前景点和背景点")
...
plt.axis('off')
plt.savefig("research/sam/examples/5-单框确定一个物体.png")
print(f"5-单框确定一个物体")
...
show_points(input_point, input_label, plt.gca())
plt.axis('off')
plt.savefig("research/sam/examples/6-框和背景点确定物体.png")
print(f"6-框和背景点确定物体")
...
plt.axis('off')
plt.savefig("research/sam/examples/7-多组框和点确定不同物体.png")
...
for box in input_boxes:
    show_box(box, plt.gca())
plt.axis('off')
plt.savefig("research/sam/examples/8-多个框确定不同物体.png")
print(f"8-多个框确定不同物体")
...
for i, (mask, score) in enumerate(zip(masks, scores)):
    ...
    plt.title(f"Mask {i+1}, Score: {score:.3f}", fontsize=18)
    plt.axis('off')
    plt.savefig(f"research/sam/examples/9-单点确定一个物体_{i}.png")
...
for i, (mask, score) in enumerate(zip(masks, scores)):
    ...
    plt.title(f"Mask {i+1}, Score: {score:.3f}", fontsize=18)
    plt.axis('off')
    plt.savefig(f"research/sam/examples/10-单点确定一个物体_{i}.png")
