...
![1-单点确定一个物体_1](examples/1-单点确定一个物体_1.png)

![1-单点确定一个物体_2](examples/1-单点确定一个物体_2.png)
...
![3-两点确定不同物体](examples/3-两点确定不同物体.png)
...
![5-单框确定一个物体](examples/5-单框确定一个物体.png)
...
![7-多组框和点确定不同物体](examples/7-多组框和点确定不同物体.png)
