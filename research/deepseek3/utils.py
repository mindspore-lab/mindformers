...
def convert_model_config(configs):
    ...
    configs.ffn_hidden_size = configs.intermediate_size
    ...
    parallel_config.tensor_model_parallel_size = parallel_config.model_parallel
    parallel_config.pipeline_model_parallel_size = parallel_config.pipeline_stage
    parallel_config.expert_parallel = parallel_config.expert_parallel
