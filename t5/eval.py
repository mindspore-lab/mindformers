...
from src.t5 import TransformerModel
...
config.parallel_config = TransformerOpParallelConfig(data_parallel=config.data_parallel,
                                                     model_parallel=config.model_parallel,
                                                     recompute=config.recompute,
                                                     pipeline_stage=config.pipeline_stage,
                                                     micro_batch_num=config.micro_batch_num,
                                                     optimizer_shard=config.optimizer_shard,
                                                     gradient_aggregation_group=config.gradient_aggregation_group,
                                                     vocab_emb_dp=config.vocab_emb_dp)
...
def run_transformer_eval():
    ...
    tfm_model = TransformerModel(config=config)
