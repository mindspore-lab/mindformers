...
class XFormerRegister:
    ...
    @classmethod
    def register(cls, module_type=XFormerModuleType.COMMON, alias=None):
    ...
    @classmethod
    def register_cls(cls, register_class, module_type=XFormerModuleType.COMMON, alias=None):
    ...
    @classmethod
    def get_instance_from_cfg(cls, cfg, module_type=XFormerModuleType.COMMON, default_args=None):
        """Get instance.
        Args:
    ...
    @classmethod
    def get_instance(cls, module_type=XFormerModuleType.COMMON, class_name=None, *args, **kwargs):
        """Get instance.
        Args:
            module_type : module type
