...
def reverse_trans_rope_weight(weight, qk_pos_emb_head_dim):
    """
    Reverse of trans_rope_weight,
        from [cos0, cos1, ..., sin0, sin1, ...] to [cos0, sin0, cos1, sin1, ...].
    """
    rope_part = weight[..., -qk_pos_emb_head_dim:, :]
    half = qk_pos_emb_head_dim // 2
    w1 = rope_part[..., :half, :]
    w2 = rope_part[..., half:, :]

    restored_rope = np.zeros_like(rope_part)
    restored_rope[..., 0::2, :] = w1
    restored_rope[..., 1::2, :] = w2

    weight[..., -qk_pos_emb_head_dim:, :] = restored_rope
    return weight
